...
Aim of this fix is to enable widescreen grapchis and set proper camera height in game.
...
`GameData.ini` file might not exist at first so you'll have to creat it from scratch
